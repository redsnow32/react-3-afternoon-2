...
class Edit extends Component {
    ...
    componentWillMount () {
        axios.get(`/api/blog/${this.props.match.params.id}`).then((resp)=> {
            let blog = resp.data;
            this.setState({
                title:blog.title,
    ...
    updatePost () {
        ...
        axios.put(`/api/blog/${this.props.match.params.id}`).then((resp)=> {
    ...
    deletePost () {
        axios.delete(`/api/blog/${this.props.match.params.id}`).then((resp)=>{
